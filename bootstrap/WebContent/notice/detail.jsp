...
//notice 본문 가져오기
$.ajax({
	url:"/notice/detail.do?"+queryParams,
	type:'post',
	dataType: 'json',
	success:function(notice){
		...
		printData(notice.noticeAttachList,$('div.attachList'),$('#attach-div-template'),'.attach');
	},
	error:function(xhr){
...
function modify_go(){
	location.href="/notice/modify.do?nno="+nno;
}
function remove_go(){
	if(confirm("정말 삭제하시겠습니까?")){
		location.href="/notice/remove.do?nno="+nno;
	}
}
</script>
